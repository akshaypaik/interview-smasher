...
const JobStatusCards = ({ info }) => {
    ...
    return (
        <div className='mb-18 px-12 grid gap-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5'>
            <div className='flex gap-4 justify-center items-center bg-white shadow border border-gray-100 px-16 py-6 
            ...
            <div className='flex gap-4 justify-center items-center bg-white shadow border border-gray-100 px-16 py-8 
            rounded-lg hover:shadow-2xl dark:bg-gray-800'>
                <span>
