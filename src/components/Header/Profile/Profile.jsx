...
const Profile = () => {
    ...
    return (
        <div className='profile-container'>
            {/* <Link to={"/login"}> */}
            {!userInfo?.uid && <button className='profile-login-btn' onClick={handleLoginClick}>
            ...
            {userInfo?.uid && <div className='user-avatar-container'>
                {userInfo?.photoURL ?
                ...
                {showAvatarDetails && <div className='avatar-details'>
                    <ul>
            ...
            {/* </Link> */}
            {!userInfo?.uid && <div className='dark-mode-container' onClick={handleDarkMode}>
                {darkMode ?
